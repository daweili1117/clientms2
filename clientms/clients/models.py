...
class Vehicle(models.Model):
    ...
    VIN = models.PositiveBigIntegerField(blank=False, null=False, default=' ')
    DatePurchase = models.DateField(auto_now=False, auto_now_add=False)
    LastService = models.DateField(auto_now=False, auto_now_add=False)

    def __str__(self):
        return "%s %s" % (self.client, self.VIN)
